...
@ConfigGroup("SepulchreStewardConfig")
public interface SepulchreStewardConfig extends Config {
    @ConfigItem(
            keyName = "Toggle",
            name = "Toggle",
            description = "",
    ...
    @ConfigItem(
            keyName = "sendDebug",
            name = "Send Debug",
            description = "Send debug when toggled",
            position = 4
    )
    default boolean sendDebug() {
        return true;
    }
}